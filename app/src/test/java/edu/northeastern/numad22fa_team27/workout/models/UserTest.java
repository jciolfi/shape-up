...
public class UserTest {
    ...
    public void setUp() {
        ...
        workouts.add(new Workout(new UUID(128, 64), "w1", List.of(mp1), List.of(WorkoutCategory.BALANCE), 5.0F));
        workouts.add(new Workout(new UUID(128, 64), "w2", List.of(mp1, mp2), List.of(WorkoutCategory.BALANCE, WorkoutCategory.ACCURACY), 4.5F));
        workouts.add(new Workout(new UUID(128, 64), "w3", List.of(mp2), List.of(WorkoutCategory.STRENGTH), 2.0F));
        workouts.add(new Workout(new UUID(128, 64), "w4", List.of(mp2, mp1), List.of(WorkoutCategory.POWER, WorkoutCategory.SPEED, WorkoutCategory.FLEXIBILITY), 3.99F));
    }
