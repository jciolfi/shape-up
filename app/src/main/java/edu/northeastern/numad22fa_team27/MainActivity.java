...
import edu.northeastern.numad22fa_team27.workout.activity.MigrationActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSU.setOnClickListener(view -> Util.openActivity(this, MigrationActivity.class));
    }
}